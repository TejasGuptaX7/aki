...
async def metrics() -> Response:
    ...
    async with SessionLocal() as db:
        ...
        lines.append(f"# HELP aki_org_total Total organizations")
        lines.append(f"# TYPE aki_org_total gauge")
        ...
        lines.append(f"# HELP aki_dept_total Total departments")
        lines.append(f"# TYPE aki_dept_total gauge")
        ...
        lines.append(f"# HELP aki_jobs_total Total jobs by status")
        lines.append(f"# TYPE aki_jobs_total gauge")
        ...
        lines.append(f"# HELP aki_cost_total Cumulative cost USD")
        lines.append(f"# TYPE aki_cost_total counter")
        ...
        lines.append(f"# HELP aki_chat_total Total chat completions")
        lines.append(f"# TYPE aki_chat_total counter")
        ...
        lines.append(f"# HELP aki_brain_chunks_total Total brain chunks")
        lines.append(f"# TYPE aki_brain_chunks_total gauge")
    ...
    try:
        ...
        async for _ in r.scan_iter(match="hermes:registry:*"):
            container_count += 1
        await r.close()
        lines.append(f"# HELP aki_hermes_containers Running Hermes containers")
        lines.append(f"# TYPE aki_hermes_containers gauge")
